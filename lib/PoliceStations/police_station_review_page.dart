...
class PoliceStationReviewPage extends StatefulWidget {
  String stationId, stationName;

  PoliceStationReviewPage(this.stationId, this.stationName);

  @override
  State<StatefulWidget> createState() {
    return PoliceStationReviewPageState();
  }
}

class PoliceStationReviewPageState extends State<PoliceStationReviewPage> {
