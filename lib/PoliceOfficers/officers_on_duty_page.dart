...
class OfficersOnDutyPage extends StatefulWidget {
  String stationName;

  OfficersOnDutyPage(this.stationName);

  @override
  State<OfficersOnDutyPage> createState() => OfficersOnDutyPageState();
}

class OfficersOnDutyPageState extends State<OfficersOnDutyPage> {
